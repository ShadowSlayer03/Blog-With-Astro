...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  const defaultColors = theme === 'dark'
    ? ['#22d3ee', '#0ea5e9', '#1d4ed8']
    : ['#020617', '#0f172a', '#1e3a8a'];

  const activeColors = colors || defaultColors;
  const activeBg = backgroundColor || (theme === 'dark' ? '#060010' : '#ffffff');
  const activeGlowColor = glowColor || (theme === 'dark' ? '205 100 62' : '221 83 24');
  const activeBorderClass = theme === 'dark' ? 'border-cyan-400/15' : 'border-slate-200/50';
  ...
  return (
    <div
      ...
      className={`relative grid isolate border ${activeBorderClass} ${className}`}
      style={{
        background: activeBg,
        ...
        boxShadow: theme === 'dark' 
          ...
          : 'rgba(0,0,0,0.05) 0 1px 2px, rgba(0,0,0,0.05) 0 8px 16px',
      }}
    >
      ...
      <div
        ...
        style={{
          ...
          background: [
            `linear-gradient(${activeBg} 0 100%) padding-box`,
